import 'package:basic_flutter/models/post_model.dart';
import 'package:basic_flutter/models/story_model.dart';
import 'package:basic_flutter/models/user_model.dart';

final User currentUser = User(
  name: 'Wizzzy',
  imageUrl:
      'https://i.pinimg.com/736x/2a/b3/16/2ab3169a053c70dc0038a24ad8ba98b2.jpg',
);
...
final List<Post> posts = [
  Post(
    user: currentUser,
    caption: 'Check out this snob !',
    timeAgo: '58m',
    imageUrl:
        'https://i.pinimg.com/originals/82/a1/e7/82a1e7229fce584fd30fd2eb20ad727c.gif',
    likes: 1202,
    comments: 184,
    shares: 96,
  ),
